...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="html_links_bookmarks.asp">&#10094; Previous</a>
...
<p>The <code class="w3-codespan">width</code>, <code class="w3-codespan">height</code>, and <code class="w3-codespan">style</code> attributes are valid in HTML.</p>
...
<div class="w3-panel w3-note">
  <p>Loading images takes time. Large images can slow down your page. Use images carefully.</p>
</div>
<hr>
<h2>HTML Exercises</h2>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_html_images1" method="post" target="_blank">
...
<p><a target="_blank" href="exercise.asp?filename=exercise_html_images1">Start the Exercise</a></p>
</div>
</form>
<hr>
